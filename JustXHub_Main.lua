...
-- Оригинал: bocaj111004/Abysall — Main.luau
...
---------------------------------------------------------
-- Персонаж (будет заполнен в HandleCharacter)
---------------------------------------------------------
...
-- Ноды для автоходьбы
---------------------------------------------------------
Globals.SeekNodesFolder = Instance.new("Folder", workspace)
Globals.SeekNodesFolder.Name = "JXH_SeekNodes"
Globals.RoomsNodesFolder = Instance.new("Folder", workspace)
...
notifySec:TextBox({ Name="Chat Message",     Flag="N_ChatMsg",  Default="is nearby!",
    Callback=function(v) entityChatMsg=v end })
...
local bypassGiggle=false,bypassDupe=false,bypassEyes=false,bypassLookman=false
local bypassGloombat=false,bypassSeekObs=false,bypassVacuum=false,bypassKillbrick=false
local bypassSeekWall=false,bypassSnare=false,bypassBanana=false,bypassJeff=false
