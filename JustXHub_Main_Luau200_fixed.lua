...
local UI = {}
local S = {}
UI.charSec= GeneralTab:Section({Title="Character", Column="left"})
...
UI.charSec:Slider({Name="Speed Boost", Flag="G_SpeedVal", Min=0, Max=100, Default=0, Decimals=0,
    Callback=function(v) S.speedBoostVal=v
        if S.speedBoostEnabled and Humanoid then Humanoid.WalkSpeed=getCurrentSpeed(v) end
    end})
UI.charSec:Toggle({Name="Enable Speed Boost", Flag="G_Speed", Default=false,
    Callback=function(v) S.speedBoostEnabled=v
        if not v and Humanoid then Humanoid.WalkSpeed=getCurrentSpeed(0) end
    end})
UI.charSec:Divider()
UI.charSec:Toggle({Name="Fly", Flag="G_Fly", Default=false, Callback=function(v) S.flyEnabled=v end})
UI.charSec:Slider({Name="Fly Speed", Flag="G_FlySpeed", Min=0, Max=115, Default=20, Decimals=0,
    Callback=function(v) S.flySpeed=v end})
UI.charSec:Divider()
UI.charSec:Toggle({Name="Noclip", Flag="G_Noclip", Default=false, Callback=function(v) S.noclipEnabled=v end})
UI.charSec:Toggle({Name="Remove Closet Delay", Flag="G_ClosetDelay", Default=false,
    Callback=function(v) S.removeClosetDelay=v end})
UI.charSec:Toggle({Name="Remove Acceleration", Flag="G_NoAccel", Default=false,
...
UI.selfSec:Toggle({Name="Door Reach", Flag="S_DoorReach", Default=false,
    Callback=function(v) S.doorReach=v end})
UI.selfSec:Toggle({Name="Disable Idle Kick", Flag="S_IdleKick", Default=false,
    Callback=function(v) S.disableIdleKick=v end})
UI.selfSec:Divider()
UI.selfSec:Slider({Name="Prompt Reach Multiplier", Flag="S_PromptReach", Min=1, Max=2, Default=1, Decimals=1,
...
UI.selfSec:Toggle({Name="Instant Prompts", Flag="S_InstantPrompts", Default=false,
    Callback=function(v) S.instantPrompts=v
        for _,p in Objects.Prompts do
            p.HoldDuration=v and 0 or (p:GetAttribute("HoldDuration_Old") or p.HoldDuration)
        end
    end})
UI.selfSec:Toggle({Name="Prompt Clip", Flag="S_PromptClip", Default=false,
...
-- Automation
UI.autoSec= GeneralTab:Section({Title="Automation", Column="right"})
...
UI.autoSec:Toggle({Name="Auto Closet", Flag="A_AutoCloset", Default=false,
    Callback=function(v) S.autoCloset=v end})
UI.autoSec:Dropdown({Name="Auto Closet Ignore List", Flag="A_ClosetIgnore",
...
UI.autoSec:Toggle({Name="Spectate Entity", Flag="A_Spectate", Default=false,
    Callback=function(v) S.spectateEntity=v end})
UI.autoSec:Dropdown({Name="Spectate Mode", Flag="A_SpectateMode",
    Options={"Player to Entity","Entity to Player"}, Default="Player to Entity",
    Callback=function(v) S.spectateMode=v end})
UI.autoSec:Divider()
UI.autoSec:Toggle({Name="Auto Breaker Box", Flag="A_BreakerBox", Default=false,
...
UI.autoSec:Toggle({Name="Auto Heartbeat Minigame", Flag="A_Heartbeat", Default=false,
    Callback=function(v) S.autoHeartbeat=v end})
UI.autoSec:Toggle({Name="Auto Solve Anchors", Flag="A_Anchors", Default=false,
    Callback=function(v) S.autoSolveAnchors=v end})
UI.autoSec:Divider()
UI.autoSec:Toggle({Name="Auto Unlock Padlock", Flag="A_Padlock", Default=false,
    Callback=function(v) S.autoUnlockPadlock=v end})
UI.autoSec:Slider({Name="Unlock Distance", Flag="A_PadlockDist", Min=1, Max=50, Default=10, Decimals=0,
    Callback=function(v) S.unlockDist=v end})
UI.autoSec:Toggle({Name="Guess Library Code", Flag="A_LibGuess", Default=false,
    Callback=function(v) S.autoGuessLibCode=v end})
UI.autoSec:Divider()
UI.autoSec:Toggle({Name="Auto Interact", Flag="A_Interact", Default=false,
    Callback=function(v) S.autoInteract=v end})
UI.autoSec:Dropdown({Name="Interact Ignore List", Flag="A_InteractIgnore",
...
UI.autoSec:Divider()
UI.autoSec:Toggle({Name="Infinite Revives", Flag="A_AutoRevive", Default=false,
    Callback=function(v) S.autoRevive=v end})

-- Misc
UI.miscSec= GeneralTab:Section({Title="Miscellaneous", Column="right"})
UI.miscSec:Button({Name="Play Again",      Callback=function() pcall(function() RemotesFolder.PlayAgain:FireServer() end) end})
UI.miscSec:Button({Name="Return to Lobby", Callback=function() pcall(function() RemotesFolder.Lobby:FireServer() end) end})
UI.miscSec:Button({Name="Revive",          Callback=function() pcall(function() RemotesFolder.Revive:FireServer() end) end})
UI.miscSec:Button({Name="Reset Character", Callback=function()
...
-- Notifications
UI.notifySec= GeneralTab:Section({Title="Notifications", Column="right"})
...
S.entityOptions={"Rush","Ambush","Eyes","Halt","Blitz","Lookman","Gloombat Swarm","A-60","A-120","Sally","Jeff the Killer","Groundskeeper","Monument","AR0xMBUSH","RNIUSHCG=="}
S.itemOptions={}
for _,v in pairs(ItemNames) do if not table.find(S.itemOptions,v) then table.insert(S.itemOptions,v) end end

UI.notifySec:Dropdown({Name="Entity List", Flag="N_EntityList", Options=S.entityOptions,
    Default={}, MultiSelect=true, MaxSelect=999, Callback=function(v) S.notifyEntityList=v end})
UI.notifySec:Toggle({Name="Notify Entities", Flag="N_Entities", Default=false,
    Callback=function(v) S.notifyEntities=v end})
UI.notifySec:Divider()
UI.notifySec:Dropdown({Name="Item List", Flag="N_ItemList", Options=S.itemOptions,
    Default={}, MultiSelect=true, MaxSelect=999, Callback=function(v) S.notifyItemList=v end})
UI.notifySec:Toggle({Name="Notify Items", Flag="N_Items", Default=false,
    Callback=function(v) S.notifyItems=v end})
UI.notifySec:Toggle({Name="Show Item Distance", Flag="N_ItemDist", Default=false,
    Callback=function(v) S.notifyItemDist=v end})
UI.notifySec:Divider()
UI.notifySec:Toggle({Name="Notify Library Code",  Flag="N_LibCode",    Default=false, Callback=function(v) S.notifyLibCode=v end})
UI.notifySec:Toggle({Name="Notify Oxygen Level",  Flag="N_Oxygen",     Default=false, Callback=function(v) S.notifyOxygen=v end})
UI.notifySec:Toggle({Name="Notify Haste Time",    Flag="N_HasteTime",  Default=false, Callback=function(v) S.notifyHasteTime=v end})
UI.notifySec:Toggle({Name="Keep Notifications",   Flag="N_KeepNotifs", Default=false, Callback=function(v) S.notifyKeepNotifs=v end})
UI.notifySec:Divider()
UI.notifySec:Toggle({Name="Entity Chat Alert",    Flag="N_Chat",       Default=false, Callback=function(v) S.entityChatEnabled=v end})
...
-- ==================== EXPLOITS ====================
-- Bypass Left
UI.bypassSec= ExploitsTab:Section({Title="Bypass", Column="left"})
...
UI.bypassSec:Toggle({Name="Bypass Giggle",            Flag="B_Giggle",   Default=false, Callback=function(v) S.bypassGiggle=v
...
UI.bypassSec:Toggle({Name="Bypass Dupe",              Flag="B_Dupe",     Default=false, Callback=function(v) S.bypassDupe=v
...
UI.bypassSec:Toggle({Name="Bypass Eyes",              Flag="B_Eyes",     Default=false, Callback=function(v) S.bypassEyes=v
...
UI.bypassSec:Toggle({Name="Bypass Lookman",           Flag="B_Lookman",  Default=false, Callback=function(v) S.bypassLookman=v
    if v and Globals.IsLookman then pcall(function()
        if Floor=="Fools" or Floor=="OldHotel" then RemotesFolder.MotorReplication:FireServer(0,(Globals.SpoofOffset==200 and 65 or -65),0,false)
        else RemotesFolder.MotorReplication:FireServer(-650) end end) end end})
UI.bypassSec:Toggle({Name="Bypass Gloombat Eggs",     Flag="B_Gloombat", Default=false, Callback=function(v) S.bypassGloombat=v
...
UI.bypassSec:Toggle({Name="Bypass Seek Obstructions", Flag="B_SeekObs",  Default=false, Callback=function(v) S.bypassSeekObs=v
...
UI.bypassSec:Toggle({Name="Bypass Vacuum",            Flag="B_Vacuum",   Default=false, Callback=function(v) S.bypassVacuum=v
...
UI.bypassSec:Toggle({Name="Bypass Killbricks",        Flag="B_Kill",     Default=false, Callback=function(v) S.bypassKillbrick=v
    for _,obj in Objects.Obstructions do if obj.Name=="Lava" then obj.CanTouch=not v end end end})
UI.bypassSec:Toggle({Name="Bypass Seeking Wall",      Flag="B_SeekWall", Default=false, Callback=function(v) S.bypassSeekWall=v
...
UI.bypassSec:Toggle({Name="Bypass Snare",             Flag="B_Snare",    Default=false, Callback=function(v) S.bypassSnare=v
    for _,obj in Objects.Entities do if obj.Name=="Snare" then
        for _,p in obj:GetDescendants() do if p:IsA("BasePart") then p.CanTouch=not v end end end end end})
UI.bypassSec:Toggle({Name="Bypass Banana",            Flag="B_Banana",   Default=false, Callback=function(v) S.bypassBanana=v
    for _,obj in Objects.Entities do if obj.Name=="BananaPeel" then obj.CanTouch=not v end end end})
UI.bypassSec:Toggle({Name="Bypass Jeff",              Flag="B_Jeff",     Default=false, Callback=function(v) S.bypassJeff=v
...
-- Bypass Right
UI.bypassRightSec= ExploitsTab:Section({Title="Bypass", Column="right"})
...
UI.bypassRightSec:Toggle({Name="Position Spoof", Flag="BR_PosSpoof", Default=false, Callback=function(v) S.posSpoof=v
...
UI.bypassRightSec:Toggle({Name="Crouch Spoof", Flag="BR_Crouch", Default=false, Callback=function(v) S.crouchSpoof=v
...
UI.bypassRightSec:Toggle({Name="Anticheat Bypass", Flag="BR_AC", Default=false, Callback=function(v) S.disableAnticheat=v
...
UI.bypassRightSec:Toggle({Name="Velocity Manipulation", Flag="BR_VelManip", Default=false,
    Callback=function(v) S.velocityManip=v end})
UI.bypassRightSec:Dropdown({Name="Manipulation Method", Flag="BR_VelMode",
    Options={"Velocity","Pivot"}, Default="Velocity",
    Callback=function(v) S.velocityManipMode=v end})
UI.bypassRightSec:Divider()
UI.bypassRightSec:Toggle({Name="Infinite Items", Flag="BR_InfItems", Default=false,
    Callback=function(v) S.infiniteItems=v end})
UI.bypassRightSec:Dropdown({Name="Item List", Flag="BR_InfItemList",
...
-- Remove
UI.removeSec= ExploitsTab:Section({Title="Remove", Column="left"})
...
UI.removeSec:Toggle({Name="Remove Screech", Flag="R_Screech", Default=false, Callback=function(v) S.removeScreech=v
...
UI.removeSec:Toggle({Name="Remove Halt",    Flag="R_Halt",    Default=false, Callback=function(v) S.removeHalt=v
    if Modules.Shade then Modules.Shade.Name=v and "Shade_Disabled" or "Shade" end end})
UI.removeSec:Toggle({Name="Remove A-90",   Flag="R_A90",     Default=false, Callback=function(v) S.removeA90=v
    if Modules.A90 then Modules.A90.Name=v and "A90_Disabled" or "A90" end end})
UI.removeSec:Toggle({Name="Remove Dread",   Flag="R_Dread",   Default=false, Callback=function(v) S.removeDread=v
    if Modules.Dread then Modules.Dread.Name=v and "Dread_Disabled" or "Dread" end end})
UI.removeSec:Toggle({Name="Remove Surge",   Flag="R_Surge",   Default=false, Callback=function(v) S.removeSurge=v
    if Globals.SurgeFrame then Globals.SurgeFrame.Name=v and "SurgeVignette_Disabled" or "SurgeVignette" end end})
UI.removeSec:Divider()
UI.removeSec:Toggle({Name="No Screech Damage", Flag="R_ScreechDmg", Default=false, Callback=function(v) S.noScreechDmg=v
...
UI.removeSec:Toggle({Name="No Halt Damage",    Flag="R_HaltDmg",    Default=false, Callback=function(v) S.noHaltDmg=v
...
UI.removeSec:Toggle({Name="No A-90 Damage",    Flag="R_A90Dmg",     Default=false, Callback=function(v) S.noA90Dmg=v
...
UI.removeSec:Toggle({Name="No Surge Damage",   Flag="R_SurgeDmg",   Default=false, Callback=function(v) S.noSurgeDmg=v
...
-- Audio
UI.audioSec= ExploitsTab:Section({Title="Audio", Column="right"})

S.removeFootsteps=false
S.removeJamminMusic=false
S.removeInteractSounds=false

UI.audioSec:Toggle({Name="Remove Footstep Sounds",    Flag="A_NoFoot",     Default=false, Callback=function(v) S.removeFootsteps=v end})
UI.audioSec:Toggle({Name="Remove Jammin Music",       Flag="A_NoJammin",   Default=false, Callback=function(v) S.removeJamminMusic=v
...
UI.audioSec:Toggle({Name="Remove Interact Sounds",    Flag="A_NoInteract", Default=false, Callback=function(v) S.removeInteractSounds=v
    if Globals.MainUI then pcall(function()
...
UI.floorBypassSec= ExploitsTab:Section({Title="Floor Bypass", Column="right"})
...
UI.floorBypassSec:Toggle({Name="Figure Godmode", Flag="FB_FigGod", Default=false, Callback=function(v) S.figureGodmode=v end})
UI.floorBypassSec:Toggle({Name="Delete Figure",  Flag="FB_DelFig", Default=false, Callback=function(v) S.removeFigure=v end})
UI.floorBypassSec:Divider()
UI.floorBypassSec:Toggle({Name="Remove Basement Gate",  Flag="FB_Basement",  Default=false, Callback=function(v) S.removeBasementGate=v
...
UI.floorBypassSec:Toggle({Name="Remove Paintings Door", Flag="FB_Paintings", Default=false, Callback=function(v) S.removePaintingsDoor=v
    for _,obj in Objects.Obstructions do if obj.Name=="MovingDoor" then
        obj:PivotTo(v and CFrame.new(-10000,-10000,-10000) or (obj:GetAttribute("OriginalPosition") or obj:GetPivot())) end end end})
UI.floorBypassSec:Toggle({Name="Remove Skeleton Door",  Flag="FB_Skeleton",  Default=false, Callback=function(v) S.removeSkeletonDoor=v
    for _,obj in Objects.Obstructions do if obj.Name=="Wax_Door" then
        obj:PivotTo(v and CFrame.new(-10000,-10000,-10000) or (obj:GetAttribute("OriginalPosition") or obj:GetPivot())) end end end})

-- Misc Exploits
UI.exploitMiscSec= ExploitsTab:Section({Title="Misc", Column="left"})
...
UI.exploitMiscSec:Toggle({Name="Disable Hide Vignette",    Flag="E_NoVig",    Default=false, Callback=function(v) S.removeHideVignette=v
    if Globals.MainUI then pcall(function()
...
UI.exploitMiscSec:Toggle({Name="Disable Firedamp Effect",  Flag="E_NoFire",   Default=false, Callback=function(v) S.disableFiredamp=v
...
UI.exploitMiscSec:Toggle({Name="Disable Entity Jumpscares",Flag="E_NoJS",     Default=false, Callback=function(v) S.disableJumpscares=v
    if Globals.MainUI then pcall(function()
...
UI.exploitMiscSec:Toggle({Name="Disable Glitch Jumpscare", Flag="E_NoGlitch", Default=false, Callback=function(v) S.disableGlitchJS=v
    if Modules.Glitch then Modules.Glitch.Name=v and "Glitch_Disabled" or "Glitch" end end})
UI.exploitMiscSec:Toggle({Name="Disable Timothy Jumpscare",Flag="E_NoTimothy",Default=false, Callback=function(v) S.disableTimothyJS=v
    if Modules.SpiderJumpscare then Modules.SpiderJumpscare.Name=v and "SpiderJumpscare_Disabled" or "SpiderJumpscare" end end})
UI.exploitMiscSec:Toggle({Name="Disable Void Jumpscare",  Flag="E_NoVoid",   Default=false, Callback=function(v) S.disableVoidJS=v
    if Modules.Void then Modules.Void.Name=v and "Void_Disabled" or "Void" end end})
UI.exploitMiscSec:Divider()
UI.exploitMiscSec:Toggle({Name="Remove Cutscenes",         Flag="E_NoCuts",   Default=false, Callback=function(v) S.removeCutscenes=v
    if Globals.MainUI then pcall(function()
...
-- ==================== VISUALS ====================
-- Camera
UI.camSec= VisualsTab:Section({Title="Camera", Column="left"})
...
UI.camSec:Toggle({Name="Ambient", Flag="V_Ambient", Default=false, Callback=function(v) S.ambientEnabled=v
    if CurrentRooms then
...
UI.camSec:ColorPicker({Name="Ambient Color", Flag="V_AmbientColor", Default=Color3.fromRGB(255,255,255),
...
UI.camSec:Slider({Name="Field of View", Flag="V_FOV", Min=1, Max=120, Default=70, Decimals=0,
    Callback=function(v) S.fovValue=v
        if Main_Game then Main_Game.fovtarget=v else Camera.FieldOfView=v end end})
UI.camSec:Divider()
UI.camSec:Toggle({Name="Remove Camera Shake",   Flag="V_NoCamShake", Default=false, Callback=function(v) S.removeCamShake=v
    if Main_Game then Main_Game.csgo=v and CFrame.new() or nil end end})
UI.camSec:Toggle({Name="Remove Camera Bobbing", Flag="V_NoBob",      Default=false, Callback=function(v) S.removeCamBobbing=v
    if Main_Game then Main_Game.spring.Speed=v and 9e9 or 8 end end})
UI.camSec:Toggle({Name="Remove Cutscenes",      Flag="V_NoCuts2",    Default=false, Callback=function(v) S.removeCutscenes=v end})
UI.camSec:Toggle({Name="Remove Fog",            Flag="V_NoFog",      Default=false, Callback=function(v) S.removeCamFog=v
...
UI.camSec:Divider()
UI.camSec:Toggle({Name="Third Person", Flag="V_ThirdPerson", Default=false, Callback=function(v) S.thirdPerson=v
...
UI.camSec:Slider({Name="X Offset",    Flag="V_ThirdX",    Min=-10, Max=10, Default=1.5, Decimals=1, Callback=function(v) S.thirdX=v end})
UI.camSec:Slider({Name="Y Offset",    Flag="V_ThirdY",    Min=-10, Max=10, Default=1,   Decimals=1, Callback=function(v) S.thirdY=v end})
UI.camSec:Slider({Name="Z Offset",    Flag="V_ThirdZ",    Min=-10, Max=10, Default=5,   Decimals=1, Callback=function(v) S.thirdZ=v end})
UI.camSec:Toggle({Name="Wall Check",  Flag="V_WallCheck", Default=false, Callback=function(v) S.thirdWallCheck=v end})
UI.camSec:Divider()
UI.camSec:Toggle({Name="Viewmodel Offset", Flag="V_ViewOff", Default=false, Callback=function(v) S.viewmodelOffset=v
    if Main_Game then Main_Game.tooloffset=v and Vector3.new(S.viewmodelX,S.viewmodelY,S.viewmodelZ) or Vector3.zero end end})
UI.camSec:Slider({Name="VM X", Flag="V_VMX", Min=-10, Max=10, Default=0, Decimals=1, Callback=function(v) S.viewmodelX=v
    if Main_Game and S.viewmodelOffset then Main_Game.tooloffset=Vector3.new(v,S.viewmodelY,S.viewmodelZ) end end})
UI.camSec:Slider({Name="VM Y", Flag="V_VMY", Min=-10, Max=10, Default=0, Decimals=1, Callback=function(v) S.viewmodelY=v
    if Main_Game and S.viewmodelOffset then Main_Game.tooloffset=Vector3.new(S.viewmodelX,v,S.viewmodelZ) end end})
UI.camSec:Slider({Name="VM Z", Flag="V_VMZ", Min=-10, Max=10, Default=0, Decimals=1, Callback=function(v) S.viewmodelZ=v
    if Main_Game and S.viewmodelOffset then Main_Game.tooloffset=Vector3.new(S.viewmodelX,S.viewmodelY,v) end end})

-- Effects
UI.effectsSec= VisualsTab:Section({Title="Effects", Column="left"})
...
UI.effectsSec:Toggle({Name="Transparent Hiding Spots", Flag="V_TranspHide", Default=false, Callback=function(v) S.transpHiding=v applyHidingTransparency(v,S.transpVal) end})
UI.effectsSec:Slider({Name="Transparency", Flag="V_TranspVal", Min=0, Max=1, Default=0.5, Decimals=2, Callback=function(v) S.transpVal=v applyHidingTransparency(S.transpHiding,v) end})
UI.effectsSec:Divider()
UI.effectsSec:Toggle({Name="Disable Glitch Jumpscare",   Flag="V_NoGlitch2",  Default=false, Callback=function(v) S.disableGlitchJS=v
    if Modules.Glitch then Modules.Glitch.Name=v and "Glitch_Disabled" or "Glitch" end end})
UI.effectsSec:Toggle({Name="Disable Timothy Jumpscare",  Flag="V_NoTimothy2", Default=false, Callback=function(v) S.disableTimothyJS=v
    if Modules.SpiderJumpscare then Modules.SpiderJumpscare.Name=v and "SpiderJumpscare_Disabled" or "SpiderJumpscare" end end})
UI.effectsSec:Toggle({Name="Disable Void Jumpscare",     Flag="V_NoVoid2",    Default=false, Callback=function(v) S.disableVoidJS=v
    if Modules.Void then Modules.Void.Name=v and "Void_Disabled" or "Void" end end})
UI.effectsSec:Divider()
UI.effectsSec:Toggle({Name="Disable Hide Vignette",      Flag="V_NoVig2",     Default=false, Callback=function(v) S.removeHideVignette=v end})
UI.effectsSec:Toggle({Name="Disable Firedamp Effect",    Flag="V_NoFire2",    Default=false, Callback=function(v) S.disableFiredamp=v end})
UI.effectsSec:Toggle({Name="Disable Entity Jumpscares",  Flag="V_NoJS2",      Default=false, Callback=function(v) S.disableJumpscares=v end})

-- ESP
UI.espSec= VisualsTab:Section({Title="ESP", Column="right"})
...
S.entityESPOptions={"Rush","Ambush","Eyes","Dupe","Figure","Blitz","Lookman","Snare","Giggle","Gloombat Eggs","Grumble","A-60","A-120","Sally","Jeff the Killer","Groundskeeper","Mandrake Hole","Monument","Bramble","Drakobloxxer","AR0xMBUSH","RNIUSHCG=="}

UI.espSec:Dropdown({Name="Entity List", Flag="ESP_EntityOpts", Options=S.entityESPOptions,
...
UI.espSec:Toggle({Name="Entities ESP",   Flag="ESP_Entities",  Default=false, Callback=function(v) S.espEntities=v
    for _,obj in Objects.Entities do
        local label=EntityESPLabels[obj.Name] or (EntityData[obj.Name] and EntityData[obj.Name].Alias)
...
UI.espSec:ColorPicker({Name="Entity Color", Flag="ESP_EntColor", Default=Color3.fromRGB(255,0,0),
    Callback=function(v) S.espEntityColor=v for _,obj in Objects.Entities do updateESPColor(obj,v) end end})
UI.espSec:Divider()
UI.espSec:Toggle({Name="Objective ESP",  Flag="ESP_Objectives", Default=false, Callback=function(v) S.espObjective=v
...
UI.espSec:ColorPicker({Name="Objective Color", Flag="ESP_ObjColor", Default=Color3.fromRGB(0,255,0),
    Callback=function(v) S.espObjectiveColor=v for _,obj in Objects.Objectives do updateESPColor(obj,v) end end})
UI.espSec:Divider()
UI.espSec:Toggle({Name="Door ESP",       Flag="ESP_Doors",     Default=false, Callback=function(v) S.espDoors=v
    for _,obj in Objects.Doors do if v then addESP(obj,"Door",S.espDoorColor,true) else removeESP(obj) end end end})
UI.espSec:ColorPicker({Name="Door Color", Flag="ESP_DoorColor", Default=Color3.fromRGB(0,200,255),
    Callback=function(v) S.espDoorColor=v for _,obj in Objects.Doors do updateESPColor(obj,v) end end})
UI.espSec:Divider()
UI.espSec:Toggle({Name="Hiding Spot ESP",Flag="ESP_Hiding",    Default=false, Callback=function(v) S.espHiding=v
    for _,obj in Objects.HidingSpots do
...
UI.espSec:ColorPicker({Name="Hiding Color", Flag="ESP_HideColor", Default=Color3.fromRGB(255,170,0),
    Callback=function(v) S.espHidingColor=v for _,obj in Objects.HidingSpots do updateESPColor(obj,v) end end})
UI.espSec:Divider()
UI.espSec:Toggle({Name="Chest ESP",      Flag="ESP_Chests",    Default=false, Callback=function(v) S.espChests=v
...
UI.espSec:ColorPicker({Name="Chest Color", Flag="ESP_ChestColor", Default=Color3.fromRGB(255,255,0),
    Callback=function(v) S.espChestColor=v for _,obj in Objects.Chests do updateESPColor(obj,v) end end})
UI.espSec:Divider()
UI.espSec:Toggle({Name="Item ESP",       Flag="ESP_Items",     Default=false, Callback=function(v) S.espItems=v
...
UI.espSec:ColorPicker({Name="Item Color", Flag="ESP_ItemColor", Default=Color3.fromRGB(170,0,255),
    Callback=function(v) S.espItemColor=v for _,obj in Objects.Items do updateESPColor(obj,v) end end})
UI.espSec:Divider()
UI.espSec:Toggle({Name="Currency ESP",   Flag="ESP_Currency",  Default=false, Callback=function(v) S.espCurrency=v
...
UI.espSec:ColorPicker({Name="Currency Color", Flag="ESP_CurrColor", Default=Color3.fromRGB(255,215,0),
    Callback=function(v) S.espCurrencyColor=v for _,obj in Objects.Currency do updateESPColor(obj,v) end end})
UI.espSec:Divider()
UI.espSec:Toggle({Name="Player ESP",     Flag="ESP_Players",   Default=false, Callback=function(v) S.espPlayers=v
...
UI.espSec:ColorPicker({Name="Player Color", Flag="ESP_PlrColor", Default=Color3.fromRGB(255,255,255),
...
UI.espSec:Divider()
UI.espSec:Toggle({Name="Ladder ESP",     Flag="ESP_Ladders",   Default=false, Callback=function(v) S.espLadders=v
    for _,obj in Objects.Ladders do if v then addESP(obj,"Ladder",S.espLadderColor,true) else removeESP(obj) end end end})
UI.espSec:ColorPicker({Name="Ladder Color", Flag="ESP_LadderColor", Default=Color3.fromRGB(255,255,255),
    Callback=function(v) S.espLadderColor=v for _,obj in Objects.Ladders do updateESPColor(obj,v) end end})

-- ESP Settings
UI.espSettingsSec= VisualsTab:Section({Title="ESP Settings", Column="right"})
UI.espSettingsSec:Toggle({Name="Show Distance",        Flag="ESP_ShowDist", Default=true,  Callback=function(v) espSettings.showDist=v end})
UI.espSettingsSec:Toggle({Name="Rainbow Effect",       Flag="ESP_Rainbow",  Default=false, Callback=function(v) espSettings.rainbow=v end})
UI.espSettingsSec:Slider({Name="Fill Transparency",    Flag="ESP_FillT",    Min=0, Max=1,  Default=0.75, Decimals=2,
    Callback=function(v) espSettings.fillT=v for _,d in pairs(espObjects) do if d.hl then d.hl.FillTransparency=v end end end})
UI.espSettingsSec:Slider({Name="Outline Transparency", Flag="ESP_OutT",     Min=0, Max=1,  Default=0,    Decimals=2,
...
-- ==================== FLOORS ====================
UI.floorAutoSec= FloorsTab:Section({Title="Automation", Column="left"})
...
UI.floorAutoSec:Toggle({Name="Auto Steer Minecart", Flag="F_Minecart", Default=false,
    Callback=function(v) S.autoSteerMinecart=v end})
UI.floorAutoSec:Slider({Name="Turn Distance",  Flag="F_TurnDist",  Min=5,  Max=60, Default=30, Decimals=0, Callback=function(v) S.autoSteerDist=v end})
UI.floorAutoSec:Slider({Name="Duck Distance",  Flag="F_DuckDist",  Min=5,  Max=40, Default=20, Decimals=0, Callback=function(v) S.autoSteerDuckDist=v end})
UI.floorAutoSec:Divider()
UI.floorAutoSec:Toggle({Name="Auto Rooms Walk", Flag="F_RoomsWalk", Default=false,
    Callback=function(v) S.roomsAutoWalk=v end})
UI.floorAutoSec:Toggle({Name="Show Path", Flag="F_ShowPath", Default=false,
...
UI.floorAutoSec:Slider({Name="Pathfind Timeout", Flag="F_PathTimeout", Min=1, Max=10, Default=3, Decimals=0,
    Callback=function(v) S.roomsPathTimeout=v end})

UI.floorVisSec= FloorsTab:Section({Title="Visuals", Column="left"})
...
UI.floorVisSec:Toggle({Name="Show Seek Path",     Flag="F_SeekPath",      Default=false, Callback=function(v) S.showSeekPath=v updateBeamVis(Objects.SeekHighlights,v) end})
UI.floorVisSec:ColorPicker({Name="Seek Color",    Flag="F_SeekPathColor", Default=Color3.fromRGB(0,255,0), Callback=function(v) S.seekPathColor=v updateBeamColor(Objects.SeekHighlights,v) end})
UI.floorVisSec:Toggle({Name="Show Eyestalk Path", Flag="F_EyePath",       Default=false, Callback=function(v) S.showEyestalkPath=v updateBeamVis(Objects.EyestalkHighlights,v) end})
UI.floorVisSec:ColorPicker({Name="Eyestalk Color",Flag="F_EyePathColor",  Default=Color3.fromRGB(0,255,0), Callback=function(v) S.eyestalkPathColor=v updateBeamColor(Objects.EyestalkHighlights,v) end})

UI.floorBypassSec2= FloorsTab:Section({Title="Bypass", Column="right"})
UI.floorBypassSec2:Toggle({Name="Delete Seek Trigger", Flag="F2_SeekTrig", Default=false, Callback=function(v) S.removeSeekTrigger=v end})
UI.floorBypassSec2:Toggle({Name="Delete Figure",       Flag="F2_DelFig",   Default=false, Callback=function(v) S.removeFigure=v end})
UI.floorBypassSec2:Toggle({Name="Figure Godmode",      Flag="F2_FigGod",   Default=false, Callback=function(v) S.figureGodmode=v end})
UI.floorBypassSec2:Toggle({Name="Infinite Revives",    Flag="F2_AutoRev",  Default=false, Callback=function(v) S.autoRevive=v end})
UI.floorBypassSec2:Divider()
UI.floorBypassSec2:Toggle({Name="Remove Basement Gate",  Flag="F2_Basement",  Default=false, Callback=function(v) S.removeBasementGate=v
    for _,obj in Objects.Obstructions do if obj.Name=="ThingToOpen" then
        obj:PivotTo(v and CFrame.new(-10000,-10000,-10000) or (obj:GetAttribute("OriginalPosition") or obj:GetPivot())) end end end})
UI.floorBypassSec2:Toggle({Name="Remove Paintings Door", Flag="F2_Paintings", Default=false, Callback=function(v) S.removePaintingsDoor=v
    for _,obj in Objects.Obstructions do if obj.Name=="MovingDoor" then
        obj:PivotTo(v and CFrame.new(-10000,-10000,-10000) or (obj:GetAttribute("OriginalPosition") or obj:GetPivot())) end end end})
UI.floorBypassSec2:Toggle({Name="Remove Skeleton Door",  Flag="F2_Skeleton",  Default=false, Callback=function(v) S.removeSkeletonDoor=v
    for _,obj in Objects.Obstructions do if obj.Name=="Wax_Door" then
        obj:PivotTo(v and CFrame.new(-10000,-10000,-10000) or (obj:GetAttribute("OriginalPosition") or obj:GetPivot())) end end end})

UI.floorFarmSec= FloorsTab:Section({Title="Farming", Column="right"})
UI.floorFarmSec:Toggle({Name="Knob Farm", Flag="F_KnobFarm", Default=false, Callback=function(v)
    if v then notify("Collect gold first.","Click 'Start Knob Farm' when ready.")
    else Globals.KnobFarmStarted=false end end})
UI.floorFarmSec:Button({Name="Start Knob Farm", Callback=function()
    if LatestRoom and LatestRoom.Value~=0 then notify("Must be in Room 0.") return end
    Globals.KnobFarmStarted=true end})

UI.floorComplSec= FloorsTab:Section({Title="Completion", Column="right"})
UI.floorComplSec:Button({Name="Auto Complete Dam Seek", Callback=function()
...
UI.floorComplSec:Button({Name="Auto Complete Cringle", Callback=function()
...
Globals.S.FlyBody = S.FlyBody
Globals.S.ManipulateBody = S.ManipulateBody
...
-- ==================== ARCHIVES TAB ====================
UI.ArchivesTab= Win:Tab({Label="Archives", Icon="folder"})
...
-- Archives Exploits
UI.archMiscSec= UI.ArchivesTab:Section({Title="Exploits / Anti", Column="right"})

UI.archMiscSec:Toggle({Name="Anti Ransom", Flag="AR_Ransom", Default=false,
    Callback=function(v)
...
UI.archMiscSec:Toggle({Name="Anti Closet Trash", Flag="AR_ClosetTrash", Default=false,
    Callback=function(v)
...
UI.archMiscSec:Toggle({Name="Forget Me Not Skipper", Flag="AR_ForgetMeNot", Default=false,
    Callback=function(v)
...
UI.archMiscSec:Toggle({Name="Time Shower", Flag="AR_TimeShower", Default=false,
    Callback=function(v)
        S.TimeShowerToken+=1
...
UI.archMiscSec:Toggle({Name="Stop Time / Anti Stampede", Flag="AR_StopTime", Default=false,
    Callback=function(v)
...
UI.archMiscSec:Toggle({Name="Honcho Correct Box ESP", Flag="AR_HonchoESP", Default=false,
    Callback=function(v)
...
-- Archives Bypasses
UI.archBypassSec= UI.ArchivesTab:Section({Title="Bypasses", Column="left"})

UI.archBypassSec:Toggle({Name="Bypass Electric Water", Flag="AB_Water", Default=false,
    Callback=function(v)
...
UI.archBypassSec:Toggle({Name="Bypass Alma", Flag="AB_Alma", Default=false,
    Callback=function(v)
...
UI.archBypassSec:Toggle({Name="Bypass Drones", Flag="AB_Drones", Default=false,
    Callback=function(v)
...
UI.archBypassSec:Toggle({Name="Bypass Scribbles", Flag="AB_Scribbles", Default=false,
    Callback=function(v)
...
-- ==================== STAIRWELL TAB ====================
UI.StairwellTab= Win:Tab({Label="Stairwell", Icon="stairs"})

UI.stairExpSec= UI.StairwellTab:Section({Title="Experimental", Column="left"})

UI.stairExpSec:Button({Name="Bring Dropped Items",
    Callback=function()
        local drops=workspace:FindFirstChild("Drops")
...
UI.stairExpSec:Toggle({Name="Anti Noise", Flag="SW_AntiNoise", Default=false,
    Callback=function(v)
...
UI.stairMiscSec= UI.StairwellTab:Section({Title="Exploits / Anti", Column="right"})
UI.stairMiscSec:Label({Text="Stairwell features coming soon."})
...
UI.debugSec= GeneralTab:Section({Title="Debug", Column="right"})
UI.debugSec:Button({Name="Void (Y -120)", Callback=function()
    if not Character then return end
    local pivot=Character:GetPivot()
    for _=1,22 do Character:PivotTo(pivot+Vector3.new(0,-120-pivot.Position.Y,0)) end
    notify("Teleported to void.")
end})
UI.debugSec:Button({Name="Exit Closet", Callback=function()
    pcall(function() RemotesFolder.CamLock:FireServer() end)
end})
...
UI.infCrucifixSec= ExploitsTab:Section({Title="Infinite Crucifix", Column="right"})
UI.infCrucifixSec:Toggle({Name="Infinite Crucifix", Flag="IC_Toggle", Default=false,
    Callback=function(v)
...
UI.infCrucifixSec:Label({Text="Risky! Low ping + stable FPS recommended."})
...
S.ok_ls,S.LogService=pcall(function() return game:GetService("LogService") end)
if S.ok_ls and S.LogService then
    local haltLogConn=S.LogService.MessageOut:Connect(function(msg)
