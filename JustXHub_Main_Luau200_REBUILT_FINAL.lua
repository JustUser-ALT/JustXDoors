...
charSec:Divider()
charSec:Toggle({Name="Fly", Flag="G_Fly", Default=false, Callback=function(v) S.flyEnabled=v end})
charSec:Slider({Name="Fly Speed", Flag="G_FlySpeed", Min=0, Max=115, Default=20, Decimals=0,
    Callback=function(v) S.flySpeed=v end})
charSec:Divider()
charSec:Toggle({Name="Noclip", Flag="G_Noclip", Default=false, Callback=function(v) S.noclipEnabled=v end})
...
autoSec:Dropdown({Name="Auto Closet Ignore List", Flag="A_ClosetIgnore",
    Options={"Rush","Ambush","Blitz","A-60","A-120","AR0xMBUSH","RNIUSHCG==","Balls","Noise","Creak","DronesStampede","Teller","Scribbles","Bash"},
...
notifySec:Dropdown({Name="Entity List", Flag="N_EntityList", Options=S.entityOptions,
    Default={}, MultiSelect=true, MaxSelect=999, Callback=function(v)
        local t={}
        if type(v)=="table" then
            for k,val in pairs(v) do
                if type(k)=="number" then t[val]=true elseif val then t[k]=true end
            end
        end
        S.notifyEntityList=t
    end})
notifySec:Toggle({Name="Notify Entities", Flag="N_Entities", Default=false,
    Callback=function(v) S.notifyEntities=v end})
notifySec:Divider()
notifySec:Dropdown({Name="Item List", Flag="N_ItemList", Options=S.itemOptions,
...
notifySec:Divider()
notifySec:Toggle({Name="Notify Library Code",  Flag="N_LibCode",    Default=false, Callback=function(v) S.notifyLibCode=v end})
notifySec:Toggle({Name="Notify Oxygen Level",  Flag="N_Oxygen",     Default=false, Callback=function(v) S.notifyOxygen=v end})
notifySec:Toggle({Name="Notify Haste Time",    Flag="N_HasteTime",  Default=false, Callback=function(v) S.notifyHasteTime=v end})
notifySec:Toggle({Name="Keep Notifications",   Flag="N_KeepNotifs", Default=false, Callback=function(v) S.notifyKeepNotifs=v end})
notifySec:Divider()
notifySec:Toggle({Name="Entity Chat Alert",    Flag="N_Chat",       Default=false, Callback=function(v) S.entityChatEnabled=v end})
...
bypassSec:Toggle({Name="Bypass Giggle",            Flag="B_Giggle",   Default=false, Callback=function(v) S.bypassGiggle=v
...
bypassSec:Toggle({Name="Bypass Dupe",              Flag="B_Dupe",     Default=false, Callback=function(v) S.bypassDupe=v
...
bypassSec:Toggle({Name="Bypass Eyes",              Flag="B_Eyes",     Default=false, Callback=function(v) S.bypassEyes=v
...
bypassSec:Toggle({Name="Bypass Lookman",           Flag="B_Lookman",  Default=false, Callback=function(v) S.bypassLookman=v
    if v and Globals.IsLookman then pcall(function()
        if Floor=="Fools" or Floor=="OldHotel" then RemotesFolder.MotorReplication:FireServer(0,(Globals.SpoofOffset==200 and 65 or -65),0,false)
        else RemotesFolder.MotorReplication:FireServer(-650) end end) end end})
bypassSec:Toggle({Name="Bypass Gloombat Eggs",     Flag="B_Gloombat", Default=false, Callback=function(v) S.bypassGloombat=v
...
bypassSec:Toggle({Name="Bypass Seek Obstructions", Flag="B_SeekObs",  Default=false, Callback=function(v) S.bypassSeekObs=v
...
bypassSec:Toggle({Name="Bypass Vacuum",            Flag="B_Vacuum",   Default=false, Callback=function(v) S.bypassVacuum=v
...
bypassSec:Toggle({Name="Bypass Killbricks",        Flag="B_Kill",     Default=false, Callback=function(v) S.bypassKillbrick=v
    for _,obj in Objects.Obstructions do if obj.Name=="Lava" then obj.CanTouch=not v end end end})
bypassSec:Toggle({Name="Bypass Seeking Wall",      Flag="B_SeekWall", Default=false, Callback=function(v) S.bypassSeekWall=v
...
bypassSec:Toggle({Name="Bypass Snare",             Flag="B_Snare",    Default=false, Callback=function(v) S.bypassSnare=v
    for _,obj in Objects.Entities do if obj.Name=="Snare" then
        for _,p in obj:GetDescendants() do if p:IsA("BasePart") then p.CanTouch=not v end end end end end})
bypassSec:Toggle({Name="Bypass Banana",            Flag="B_Banana",   Default=false, Callback=function(v) S.bypassBanana=v
    for _,obj in Objects.Entities do if obj.Name=="BananaPeel" then obj.CanTouch=not v end end end})
bypassSec:Toggle({Name="Bypass Jeff",              Flag="B_Jeff",     Default=false, Callback=function(v) S.bypassJeff=v
...
bypassRightSec:Toggle({Name="Position Spoof", Flag="BR_PosSpoof", Default=false, Callback=function(v) S.posSpoof=v
...
bypassRightSec:Toggle({Name="Crouch Spoof", Flag="BR_Crouch", Default=false, Callback=function(v) S.crouchSpoof=v
...
bypassRightSec:Toggle({Name="Anticheat Bypass", Flag="BR_AC", Default=false, Callback=function(v) S.disableAnticheat=v
...
removeSec:Toggle({Name="Remove Screech", Flag="R_Screech", Default=false, Callback=function(v) S.removeScreech=v
...
removeSec:Toggle({Name="Remove Halt",    Flag="R_Halt",    Default=false, Callback=function(v) S.removeHalt=v
    if Modules.Shade then Modules.Shade.Name=v and "Shade_Disabled" or "Shade" end end})
removeSec:Toggle({Name="Remove A-90",   Flag="R_A90",     Default=false, Callback=function(v) S.removeA90=v
    if Modules.A90 then Modules.A90.Name=v and "A90_Disabled" or "A90" end end})
removeSec:Toggle({Name="Remove Dread",   Flag="R_Dread",   Default=false, Callback=function(v) S.removeDread=v
    if Modules.Dread then Modules.Dread.Name=v and "Dread_Disabled" or "Dread" end end})
removeSec:Toggle({Name="Remove Surge",   Flag="R_Surge",   Default=false, Callback=function(v) S.removeSurge=v
    if Globals.SurgeFrame then Globals.SurgeFrame.Name=v and "SurgeVignette_Disabled" or "SurgeVignette" end end})
removeSec:Divider()
removeSec:Toggle({Name="No Screech Damage", Flag="R_ScreechDmg", Default=false, Callback=function(v) S.noScreechDmg=v
...
removeSec:Toggle({Name="No Halt Damage",    Flag="R_HaltDmg",    Default=false, Callback=function(v) S.noHaltDmg=v
...
removeSec:Toggle({Name="No A-90 Damage",    Flag="R_A90Dmg",     Default=false, Callback=function(v) S.noA90Dmg=v
...
removeSec:Toggle({Name="No Surge Damage",   Flag="R_SurgeDmg",   Default=false, Callback=function(v) S.noSurgeDmg=v
...
audioSec:Toggle({Name="Remove Footstep Sounds",    Flag="A_NoFoot",     Default=false, Callback=function(v) S.removeFootsteps=v end})
audioSec:Toggle({Name="Remove Jammin Music",       Flag="A_NoJammin",   Default=false, Callback=function(v) S.removeJamminMusic=v
...
audioSec:Toggle({Name="Remove Interact Sounds",    Flag="A_NoInteract", Default=false, Callback=function(v) S.removeInteractSounds=v
    if Globals.MainUI then pcall(function()
...
floorBypassSec:Toggle({Name="Figure Godmode", Flag="FB_FigGod", Default=false, Callback=function(v) S.figureGodmode=v end})
floorBypassSec:Toggle({Name="Delete Figure",  Flag="FB_DelFig", Default=false, Callback=function(v) S.removeFigure=v end})
floorBypassSec:Divider()
floorBypassSec:Toggle({Name="Remove Basement Gate",  Flag="FB_Basement",  Default=false, Callback=function(v) S.removeBasementGate=v
...
floorBypassSec:Toggle({Name="Remove Paintings Door", Flag="FB_Paintings", Default=false, Callback=function(v) S.removePaintingsDoor=v
    for _,obj in Objects.Obstructions do if obj.Name=="MovingDoor" then
        obj:PivotTo(v and CFrame.new(-10000,-10000,-10000) or (obj:GetAttribute("OriginalPosition") or obj:GetPivot())) end end end})
floorBypassSec:Toggle({Name="Remove Skeleton Door",  Flag="FB_Skeleton",  Default=false, Callback=function(v) S.removeSkeletonDoor=v
...
exploitMiscSec:Toggle({Name="Disable Hide Vignette",    Flag="E_NoVig",    Default=false, Callback=function(v) S.removeHideVignette=v
    if Globals.MainUI then pcall(function()
...
exploitMiscSec:Toggle({Name="Disable Firedamp Effect",  Flag="E_NoFire",   Default=false, Callback=function(v) S.disableFiredamp=v
...
exploitMiscSec:Toggle({Name="Disable Entity Jumpscares",Flag="E_NoJS",     Default=false, Callback=function(v) S.disableJumpscares=v
    if Globals.MainUI then pcall(function()
...
exploitMiscSec:Toggle({Name="Disable Glitch Jumpscare", Flag="E_NoGlitch", Default=false, Callback=function(v) S.disableGlitchJS=v
    if Modules.Glitch then Modules.Glitch.Name=v and "Glitch_Disabled" or "Glitch" end end})
exploitMiscSec:Toggle({Name="Disable Timothy Jumpscare",Flag="E_NoTimothy",Default=false, Callback=function(v) S.disableTimothyJS=v
    if Modules.SpiderJumpscare then Modules.SpiderJumpscare.Name=v and "SpiderJumpscare_Disabled" or "SpiderJumpscare" end end})
exploitMiscSec:Toggle({Name="Disable Void Jumpscare",  Flag="E_NoVoid",   Default=false, Callback=function(v) S.disableVoidJS=v
    if Modules.Void then Modules.Void.Name=v and "Void_Disabled" or "Void" end end})
exploitMiscSec:Divider()
exploitMiscSec:Toggle({Name="Remove Cutscenes",         Flag="E_NoCuts",   Default=false, Callback=function(v) S.removeCutscenes=v
    if Globals.MainUI then pcall(function()
...
camSec:Toggle({Name="Ambient", Flag="V_Ambient", Default=false, Callback=function(v) S.ambientEnabled=v
    if CurrentRooms then
...
camSec:Divider()
camSec:Toggle({Name="Remove Camera Shake",   Flag="V_NoCamShake", Default=false, Callback=function(v) S.removeCamShake=v
    if Main_Game then Main_Game.csgo=v and CFrame.new() or nil end end})
camSec:Toggle({Name="Remove Camera Bobbing", Flag="V_NoBob",      Default=false, Callback=function(v) S.removeCamBobbing=v
    if Main_Game then Main_Game.spring.Speed=v and 9e9 or 8 end end})
camSec:Toggle({Name="Remove Cutscenes",      Flag="V_NoCuts2",    Default=false, Callback=function(v) S.removeCutscenes=v end})
camSec:Toggle({Name="Remove Fog",            Flag="V_NoFog",      Default=false, Callback=function(v) S.removeCamFog=v
...
camSec:Divider()
camSec:Toggle({Name="Third Person", Flag="V_ThirdPerson", Default=false, Callback=function(v) S.thirdPerson=v
...
camSec:Slider({Name="X Offset",    Flag="V_ThirdX",    Min=-10, Max=10, Default=1.5, Decimals=1, Callback=function(v) S.thirdX=v end})
camSec:Slider({Name="Y Offset",    Flag="V_ThirdY",    Min=-10, Max=10, Default=1,   Decimals=1, Callback=function(v) S.thirdY=v end})
camSec:Slider({Name="Z Offset",    Flag="V_ThirdZ",    Min=-10, Max=10, Default=5,   Decimals=1, Callback=function(v) S.thirdZ=v end})
camSec:Toggle({Name="Wall Check",  Flag="V_WallCheck", Default=false, Callback=function(v) S.thirdWallCheck=v end})
camSec:Divider()
camSec:Toggle({Name="Viewmodel Offset", Flag="V_ViewOff", Default=false, Callback=function(v) S.viewmodelOffset=v
    if Main_Game then Main_Game.tooloffset=v and Vector3.new(S.viewmodelX,S.viewmodelY,S.viewmodelZ) or Vector3.zero end end})
camSec:Slider({Name="VM X", Flag="V_VMX", Min=-10, Max=10, Default=0, Decimals=1, Callback=function(v) S.viewmodelX=v
    if Main_Game and S.viewmodelOffset then Main_Game.tooloffset=Vector3.new(v,S.viewmodelY,S.viewmodelZ) end end})
camSec:Slider({Name="VM Y", Flag="V_VMY", Min=-10, Max=10, Default=0, Decimals=1, Callback=function(v) S.viewmodelY=v
    if Main_Game and S.viewmodelOffset then Main_Game.tooloffset=Vector3.new(S.viewmodelX,v,S.viewmodelZ) end end})
camSec:Slider({Name="VM Z", Flag="V_VMZ", Min=-10, Max=10, Default=0, Decimals=1, Callback=function(v) S.viewmodelZ=v
...
effectsSec:Toggle({Name="Transparent Hiding Spots", Flag="V_TranspHide", Default=false, Callback=function(v) S.transpHiding=v applyHidingTransparency(v,S.transpVal) end})
effectsSec:Slider({Name="Transparency", Flag="V_TranspVal", Min=0, Max=1, Default=0.5, Decimals=2, Callback=function(v) S.transpVal=v applyHidingTransparency(S.transpHiding,v) end})
effectsSec:Divider()
effectsSec:Toggle({Name="Disable Glitch Jumpscare",   Flag="V_NoGlitch2",  Default=false, Callback=function(v) S.disableGlitchJS=v
    if Modules.Glitch then Modules.Glitch.Name=v and "Glitch_Disabled" or "Glitch" end end})
effectsSec:Toggle({Name="Disable Timothy Jumpscare",  Flag="V_NoTimothy2", Default=false, Callback=function(v) S.disableTimothyJS=v
    if Modules.SpiderJumpscare then Modules.SpiderJumpscare.Name=v and "SpiderJumpscare_Disabled" or "SpiderJumpscare" end end})
effectsSec:Toggle({Name="Disable Void Jumpscare",     Flag="V_NoVoid2",    Default=false, Callback=function(v) S.disableVoidJS=v
    if Modules.Void then Modules.Void.Name=v and "Void_Disabled" or "Void" end end})
effectsSec:Divider()
effectsSec:Toggle({Name="Disable Hide Vignette",      Flag="V_NoVig2",     Default=false, Callback=function(v) S.removeHideVignette=v end})
effectsSec:Toggle({Name="Disable Firedamp Effect",    Flag="V_NoFire2",    Default=false, Callback=function(v) S.disableFiredamp=v end})
effectsSec:Toggle({Name="Disable Entity Jumpscares",  Flag="V_NoJS2",      Default=false, Callback=function(v) S.disableJumpscares=v end})
...
espSec:Dropdown({Name="Entity List", Flag="ESP_EntityOpts", Options=S.entityESPOptions,
    Default={}, MultiSelect=true, MaxSelect=999, Callback=function(v)
        local t={}
        if type(v)=="table" then
            for k,val in pairs(v) do
        ...
        for _,obj in Objects.Entities do
            ...
            if label then
                if S.espEntities and S.espEntityList[label] then addESP(obj,label,S.espEntityColor,NodeEntities[label]~=true)
                else removeESP(obj) end
            end
        end end})
espSec:Toggle({Name="Entities ESP",   Flag="ESP_Entities",  Default=false, Callback=function(v) S.espEntities=v
    for _,obj in Objects.Entities do
        local label=EntityESPLabels[obj.Name] or (EntityData[obj.Name] and EntityData[obj.Name].Alias)
...
espSec:Divider()
espSec:Toggle({Name="Objective ESP",  Flag="ESP_Objectives", Default=false, Callback=function(v) S.espObjective=v
...
espSec:Divider()
espSec:Toggle({Name="Door ESP",       Flag="ESP_Doors",     Default=false, Callback=function(v) S.espDoors=v
...
espSec:Divider()
espSec:Toggle({Name="Hiding Spot ESP",Flag="ESP_Hiding",    Default=false, Callback=function(v) S.espHiding=v
    for _,obj in Objects.HidingSpots do
...
espSec:Divider()
espSec:Toggle({Name="Chest ESP",      Flag="ESP_Chests",    Default=false, Callback=function(v) S.espChests=v
...
espSec:Divider()
espSec:Toggle({Name="Item ESP",       Flag="ESP_Items",     Default=false, Callback=function(v) S.espItems=v
...
espSec:Divider()
espSec:Toggle({Name="Currency ESP",   Flag="ESP_Currency",  Default=false, Callback=function(v) S.espCurrency=v
...
espSec:Divider()
espSec:Toggle({Name="Player ESP",     Flag="ESP_Players",   Default=false, Callback=function(v) S.espPlayers=v
...
espSec:Divider()
espSec:Toggle({Name="Ladder ESP",     Flag="ESP_Ladders",   Default=false, Callback=function(v) S.espLadders=v
...
floorAutoSec:Slider({Name="Turn Distance",  Flag="F_TurnDist",  Min=5,  Max=60, Default=30, Decimals=0, Callback=function(v) S.autoSteerDist=v end})
floorAutoSec:Slider({Name="Duck Distance",  Flag="F_DuckDist",  Min=5,  Max=40, Default=20, Decimals=0, Callback=function(v) S.autoSteerDuckDist=v end})
...
floorVisSec:Toggle({Name="Show Seek Path",     Flag="F_SeekPath",      Default=false, Callback=function(v) S.showSeekPath=v updateBeamVis(Objects.SeekHighlights,v) end})
floorVisSec:ColorPicker({Name="Seek Color",    Flag="F_SeekPathColor", Default=Color3.fromRGB(0,255,0), Callback=function(v) S.seekPathColor=v updateBeamColor(Objects.SeekHighlights,v) end})
floorVisSec:Toggle({Name="Show Eyestalk Path", Flag="F_EyePath",       Default=false, Callback=function(v) S.showEyestalkPath=v updateBeamVis(Objects.EyestalkHighlights,v) end})
floorVisSec:ColorPicker({Name="Eyestalk Color",Flag="F_EyePathColor",  Default=Color3.fromRGB(0,255,0), Callback=function(v) S.eyestalkPathColor=v updateBeamColor(Objects.EyestalkHighlights,v) end})

local floorBypassSec2 = FloorsTab:Section({Title="Bypass", Column="right"})
floorBypassSec2:Toggle({Name="Delete Seek Trigger", Flag="F2_SeekTrig", Default=false, Callback=function(v) S.removeSeekTrigger=v end})
floorBypassSec2:Toggle({Name="Delete Figure",       Flag="F2_DelFig",   Default=false, Callback=function(v) S.removeFigure=v end})
floorBypassSec2:Toggle({Name="Figure Godmode",      Flag="F2_FigGod",   Default=false, Callback=function(v) S.figureGodmode=v end})
floorBypassSec2:Toggle({Name="Infinite Revives",    Flag="F2_AutoRev",  Default=false, Callback=function(v) S.autoRevive=v end})
floorBypassSec2:Divider()
floorBypassSec2:Toggle({Name="Remove Basement Gate",  Flag="F2_Basement",  Default=false, Callback=function(v) S.removeBasementGate=v
    for _,obj in Objects.Obstructions do if obj.Name=="ThingToOpen" then
        obj:PivotTo(v and CFrame.new(-10000,-10000,-10000) or (obj:GetAttribute("OriginalPosition") or obj:GetPivot())) end end end})
floorBypassSec2:Toggle({Name="Remove Paintings Door", Flag="F2_Paintings", Default=false, Callback=function(v) S.removePaintingsDoor=v
    for _,obj in Objects.Obstructions do if obj.Name=="MovingDoor" then
        obj:PivotTo(v and CFrame.new(-10000,-10000,-10000) or (obj:GetAttribute("OriginalPosition") or obj:GetPivot())) end end end})
floorBypassSec2:Toggle({Name="Remove Skeleton Door",  Flag="F2_Skeleton",  Default=false, Callback=function(v) S.removeSkeletonDoor=v
    for _,obj in Objects.Obstructions do if obj.Name=="Wax_Door" then
        obj:PivotTo(v and CFrame.new(-10000,-10000,-10000) or (obj:GetAttribute("OriginalPosition") or obj:GetPivot())) end end end})
...
S.ok_ls, S.LogService = pcall(function() return game:GetService("S.LogService") end)
